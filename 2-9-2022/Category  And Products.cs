...
namespace _2_Problem
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            p1.Qtysold = " 2 Litres";
            p1.Unitprice = 40;
            p1.Unitofmeasurment = "Litres";
            p1.Qtyinhand = "100 Litres";
            p1.Reorderlevel = 100;
            ...
            p2.Qtysold = " 5 Litres";
            p2.Unitprice = 40;
            p2.Unitofmeasurment = "Litres";
            p2.Qtyinhand = "100 Litres";
            p2.Reorderlevel = 100;
            ...
            c.CategoryId = 1;
            c.CategoryName = "Beverage";
            c.Catdescription = "Soft Drink";
            ...
            Console.WriteLine("Category Description  :" + c.Catdescription);
            Console.WriteLine("------------------------------");

            foreach (var item in c.ListofCat)
            {
...
namespace catprodlibrary
{
	public class Category
	{
		...
		private List<Products> _catlist;
