...
namespace 13sep
{
    ...
    public class User : Movie
    {
        ...
        {
            Movie m = new Movie("Vikram", "Tamil", "Action", 10);
            dbmovies.Add(m);
            Movie k = new Movie("Billa", "Tamil", "Action", 20);
            dbmovies.Add(k);
            Movie t = new Movie("Theri", "Tamil", "Action", 30);
            dbmovies.Add(t);
            Movie n = new Movie("Lion King", "English", "Animation", 30);
            dbmovies.Add(n);
